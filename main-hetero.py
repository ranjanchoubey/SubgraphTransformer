...
from src.training.training_pipeline_hetero import train_val_pipeline_hetero
...
def main():
    ...
    for fold_idx in range(config['data']['num_folds']):
        ...
        for i, subgraph in enumerate(subgraphs):
            ...
            train_mask.append(subgraph.ndata['train_mask'][:, fold_idx])
            val_mask.append(subgraph.ndata['val_mask'][:, fold_idx])
            test_mask.append(subgraph.ndata['test_mask'][:, fold_idx])
